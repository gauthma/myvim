...
syn match pdcLinkText /\[\zs[^\]]\_.\{-}\ze\]/ contains=@Spell

"   Link ID
"syn match pdcLinkID /\][ ]\{0,1}\[\zs[^\]]*\ze\]/
syn match pdcLinkID /\][ ]\{0,1}\[\zs[^\]]\_.\{-}\ze\]/

"   Skip [ so we do not highlight it --> do not highlight [***] in start of phrase?
...
syn match pdcNewLine /  $/ "--> end a line with . does not cause line break
